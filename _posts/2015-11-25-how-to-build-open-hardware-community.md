...
We’ll need to find a comprehensive way for people to understand, build and use our hardware. Our first goal is therefore to improve documentation of our projects (plans, user manuals, assembly instructions, tutorials, etc.). Lack of quality documentation is described as one of the reasons why people don’t decide for open source open hardware in [the study by OSHWA](http://www.oshwa.org/oshw-community-survey-2013/){:target="_blank"}, that’s why we want to pay a special attention to this and continue advocating for the [Useful source vision](http://irnas.eu/2015/03/08/useful-source/){:target="_blank"}.
